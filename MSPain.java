...
public class MSPain
{
    ...
    private boolean placeText = true;
    ...
    public MSPain()
    {
        ...
        UI.addButton("Click to place text", this::TextPosition);
